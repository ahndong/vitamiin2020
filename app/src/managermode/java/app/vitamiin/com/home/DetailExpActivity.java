...
public class DetailExpActivity extends BaseActivity implements View.OnClickListener, OnParseJSonListener, AdapterView.OnItemClickListener {
    ...
    TextView m_tvNick, m_tvRegdate, m_tvContent, m_tvCommentCnt, m_tvCommentCnt2, m_tvLikeCnt, m_tvViewCnt;
    ...
    private void initView() {
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////
        findViewById(R.id.lly_confirm).setOnClickListener(this);
        m_imvConfirm = (ImageView) findViewById(R.id.imv_confirm);
        m_tvConfirm = (TextView) findViewById(R.id.tv_confirm);
        
    }
    ...
    private void updateInfo() {
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////
        if(m_r_info.isok.equals("ok")){
            Glide.with(this).load(R.drawable.stamp_approved).into(m_imvConfirm);
            m_tvConfirm.setText("[승인]");
        }else if(m_r_info.isok.equals("no")){
            Glide.with(this).load(R.drawable.stamp_rejected).into(m_imvConfirm);
            m_tvConfirm.setText("[거절]");
        }else if(m_r_info.isok.equals("notyet")){
            Glide.with(this).load(R.drawable.stamp_notyet).into(m_imvConfirm);
            m_tvConfirm.setText("[검토]");
        }
        
        ...
        if (m_r_info.f_photo.equals(""))
            Glide.with(this).load(R.drawable.ic_female_3).into(m_imvPhoto);
        else
            Glide.with(this).load(Net.URL_SERVER1 + m_r_info.f_photo).into(m_imvPhoto);
    ...
    private void updateProductList() {
        //tv_good에는 제품 이름이 들어가야지; title이 왜;; by 동현
...
//                intent.putExtra("info", info);
            ...
            case R.id.lly_confirm:
                ...
                m_nConnectType = NetUtil.apis_CHANGE_ISOK;
                mNetUtilConnetServer.connectServer(this, handler, m_nConnectType, new int[] {
                                                                    m_r_info._id, int_isok});
                break;
            
...
//                    info._review_id = obj_cmt.getInt("wiki_id");
                ...
                scrollToHere = ((View) tempView.getParent().getParent().getParent()).getTop();
