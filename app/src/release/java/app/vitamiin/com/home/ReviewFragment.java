...
public class ReviewFragment extends Fragment implements View.OnClickListener, OnParseJSonListener {
    ...
    String m_order[] = {"matchcat + matchperson", "regdate"};
    ...
    public static app.vitamiin.com.home.ReviewFragment newInstance() {
        return new app.vitamiin.com.home.ReviewFragment();
    }
...
//            arrList_exp.add(new ReviewInfo());
    ...
    public void setReviewDetailCategory(int[] pos) {
        ...
        m_order[m_nConnectType] = "matchcat + matchperson";
